      ...
      <ul className="list-unstyled navbar__list">
        ...
        <li>
          <NavLink to='/admin/quanlyphim' >
            <i className="fas fa-video" />Quản Lý Phim</NavLink>
        </li>
        <li>
          <NavLink to='/admin/quanlythanhvien'>
            <i className="fas fa-users" />Quản Lý Thành Viên</NavLink>
        </li>
        <li>
          <NavLink to='/admin/quanlydatve'>
            <i className="fas fa-cart-plus" />Quản Lý Đặt Vé</NavLink>
        </li>
        <li>
          <NavLink to='/admin/quanlytintuc'>
            <i className="fas fa-newspaper  " />Quản Lý Tin Tức</NavLink>
        </li>
